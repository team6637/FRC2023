...
public class TurnToAngleCommand extends CommandBase {
    ...
    public void execute(){
        ...
        double speed = MathUtil.clamp(err * kP, -Constants.Swerve.maxAngularVelocity*0.3, Constants.Swerve.maxAngularVelocity*0.3);

        SmartDashboard.putNumber("turn to angle timer", timer.get());
